...
class HmacSha1 extends _hmac.Hmac {
  constructor(password, verify) {
    const hash = new _sha.Sha1(); // Calculate ipad, init the underlying engine, calculate this.key
  ...
  finish() {
    ...
    const result = new Uint8Array(_sha._sha1_hash_size);
    result.set(heap.subarray(0, _sha._sha1_hash_size));
