...
var _sha = require("../hash/sha512/sha512");

class HmacSha512 extends _hmac.Hmac {
  constructor(password, verify) {
    const hash = new _sha.Sha512(); // Calculate ipad, init the underlying engine, calculate this.key
  ...
  finish() {
    ...
    const result = new Uint8Array(_sha._sha512_hash_size);
    result.set(heap.subarray(0, _sha._sha512_hash_size));
