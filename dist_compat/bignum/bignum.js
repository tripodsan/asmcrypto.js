...
exports.Modulus = exports.BigNumber = exports._bigint_asm = exports._bigint_heap = exports._bigint_stdlib = void 0;

var _bigint = require("./bigint.asm");

var _utils = require("../other/utils");

var _errors = require("../other/errors");

var _extgcd = require("./extgcd");
...
exports._bigint_stdlib = _bigint_stdlib;

const _bigint_heap = new Uint32Array(0x100000);

exports._bigint_heap = _bigint_heap;

let _bigint_asm;

exports._bigint_asm = _bigint_asm;
...
if (_bigint_stdlib.Math.imul === undefined) {
  ...
  exports._bigint_asm = _bigint_asm = (0, _bigint.bigint_asm)(_bigint_stdlib, null, _bigint_heap.buffer);
...
class BigNumber {
  ...
  static fromString(str) {
    const bytes = (0, _utils.string_to_bytes)(str);
  ...
  toString(radix) {
    ...
    if (radix === 16) {
      ...
      throw new _errors.IllegalArgumentError('bad radix');
    }
  ...
  isMillerRabinProbablePrime(rounds) {
    ...
    while (--rounds >= 0) {
      (0, _getRandomValues.getRandomValues)(a.limbs);
...
BigNumber.extGCD = _extgcd.BigNumber_extGCD;
...
class Modulus extends BigNumber {
  constructor(number) {
    ...
    if (this.limbs[0] & 1) {
      ...
      const k = (0, _extgcd.Number_extGCD)(0x100000000, this.limbs[0]).y;
  ...
  inverse(a) {
    a = this.reduce(a);
    const r = (0, _extgcd.BigNumber_extGCD)(this, a);
